            ...
            with autocast(scaler is not None):
                with reporter.measure_time("forward_time"):
                    ...
                    if False:
                        ...
                        print(stat(model, (batch["speech"],batch["speech_lengths"],batch["text"],batch["text_lengths"],batch["speech_ref1"],batch["speech_ref1_lengths"])))
                        raise
                    if False:
                        from thop import profile
                        flops, params = profile(model, inputs=(batch["speech"],batch["speech_lengths"],batch["text"],batch["text_lengths"],batch["speech_ref1"],batch["speech_ref1_lengths"],))
                        #flops, params = profile(model, inputs=(batch["speech"],batch["speech_lengths"],batch["text"],batch["text_lengths"],))
