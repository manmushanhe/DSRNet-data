...
class ESPnetDataset(AbsDataset):
    ...
    def __init__(
        ...
        for path, name, _type in path_name_type_list:
            ...
            # 加载器字典，键为名称值为对应加载器，返回一个加在wav.scp的加载器
    ...
    def _build_loader(
        ...
        for key, dic in DATA_TYPES.items():
            ...
            # -> return DATA_TYPES["sound"]["func"](path)  sound_loader
    ...
    def __getitem__(self, uid: Union[str, int]) -> Tuple[str, Dict[str, np.ndarray]]:
        ...
        # speech sound_loader
        # speech_ref1 sound_loader
        # text read_2column_text
        # data是一个字典
        # {"speech":Tensor,"speech_ref1":Tensor,"text":int-id}
        # 查找一个
