...
class Dsrn_conv2d(torch.nn.Module):
    def __init__(self, use_adaptive_weight: bool = False, use_adaptive_weight_mae = False, use_asymmetric = False):
        ...
        self.conv_enhanced1 = torch.nn.Conv2d(1,32,(1,17),1,(0,8))
        self.conv_noise1 = torch.nn.Conv2d(1,32,(1,17),1,(0,8))

        self.conv_enhanced2 = torch.nn.Conv2d(32,32,(1,17),1,(0,8))
        self.conv_noise2 = torch.nn.Conv2d(32,32,(1,17),1,(0,8))

        self.conv_enh_down = torch.nn.Conv2d(32,1,(1,17),1,(0,8))
        self.conv_noise_down = torch.nn.Conv2d(32,1,(1,17),1,(0,8))
