...
from espnet2.enh.decoder.nawr_decoder import NawrDecoder
from espnet2.enh.encoder.abs_encoder import AbsEncoder
from espnet2.enh.encoder.conv_encoder import ConvEncoder
from espnet2.enh.encoder.null_encoder import NullEncoder
from espnet2.enh.encoder.stft_encoder import STFTEncoder
from espnet2.enh.encoder.lstm_encoder import LSTMEncoder
from espnet2.enh.encoder.crnn_encoder import CRNNEncoder
from espnet2.enh.encoder.demucs_encoder import DemucsEncoder
from espnet2.enh.encoder.Only_Noisy_Training_main.DCUnet10_TSTM.DCUnet import DCUnet10
...
encoder_choices = ClassChoices(
    name="encoder",
    classes=dict(stft=STFTEncoder, conv=ConvEncoder, same=NullEncoder, lstm=LSTMEncoder, crnn=CRNNEncoder, demucs=DemucsEncoder, dcunet=DCUnet10),
...
decoder_choices = ClassChoices(
    name="decoder",
    classes=dict(stft=STFTDecoder, conv=ConvDecoder, same=NullDecoder, nawr=NawrDecoder),
