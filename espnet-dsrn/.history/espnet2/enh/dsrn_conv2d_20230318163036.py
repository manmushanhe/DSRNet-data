...
class Dsrn_conv2d(torch.nn.Module):
    def __init__(self, use_adaptive_weight: bool = False, use_adaptive_weight_mae = False, use_asymmetric = False):
        ...
        self.conv_enhanced1 = torch.nn.Conv2d(1,64,(1,13),1,(0,6))
        self.conv_noise1 = torch.nn.Conv2d(1,64,(1,13),1,(0,6))

        self.conv_enhanced2 = torch.nn.Conv2d(64,64,(1,13),1,(0,6))
        self.conv_noise2 = torch.nn.Conv2d(64,64,(1,13),1,(0,6))

        self.conv_enh_down = torch.nn.Conv2d(64,1,(1,13),1,(0,6))
        self.conv_noise_down = torch.nn.Conv2d(64,1,(1,13),1,(0,6))
    ...
    def forward(self, enhanced: torch.Tensor, noise: torch.Tensor):
        ...
        enhanced1 = self.conv_enhanced1(enhanced)
        enhanced1 = self.relu1(enhanced1)

        
        enhanced1 = self.conv_enhanced2(enhanced1)
        enhanced1 = self.relu1(enhanced1)
        ...
        enh_residual1 = self.conv_enh_down(noise1 + enhanced1)

        noise_residual1 = self.conv_noise_down(noise1 + enhanced1)
