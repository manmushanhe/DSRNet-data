...
enh_asr_config=train_enh_asr_dsrn_conv2d_mask
inference_config=conf/decode_asr_transformer.yaml


enh_asr_exp=exp/enh_dsrn_conv2d_mask/gpu06_1_lr0.001_32ch_3cnn_kernel_13_mask_on_noisy
#"$HOSTNAME"_"${device}"_lr"0.001"_32ch_3cnn_kernel_13_mask_on_noisy
#"$HOSTNAME"_"${device}"_lr"0.001"_32ch_3cnn_kernel_7
