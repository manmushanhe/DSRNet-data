...
enh_asr_config=train_enh_asr_lstm_nawrn_nobn_norelu
inference_config=conf/decode_asr_transformer.yaml


enh_asr_exp=exp/enh_nawrn_new/"${enh_asr_config}"_"$HOSTNAME"_"${device}"_lr"0.001"_lstm_magnitude_50loss_enh_50loss_nawrn_SA_adaptive
