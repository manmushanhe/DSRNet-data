...
enh_asr_config=train_enh_asr_dsrn_fbank
inference_config=conf/decode_asr_transformer.yaml


enh_asr_exp=exp/enh_dsrn_fbank/gpu09_3_lr0.001_300loss_enh_loss_dsrn
#"$HOSTNAME"_"${device}"_lr"0.001"_300loss_enh_loss_dsrn
